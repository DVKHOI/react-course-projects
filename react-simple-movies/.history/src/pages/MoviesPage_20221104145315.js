...
const MoviesPage = () => {
  ...
  useEffect(() => {
    if (filterDebounce) {
      ...
      setUrl(
        `https://api.themoviedb.org/3/movie/popular?api_key=00d6e8bb848cf1aab363de510f7d4d22&${nextPage}`
      );
    }
    ...
    <div className="p-10 page-container">
      ...
      <div className="flex items-center justify-center mt-10 gap-x-5">
        ...
        {new Array(pageCount).fill(0).map((item, index) => (
          <span
            className="px-4 py-2 leading-none bg-white rounded cursor-pointer text-slate-900"
