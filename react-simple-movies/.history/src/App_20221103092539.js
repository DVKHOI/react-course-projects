        ...
        <div className="relative w-full h-full bg-white rounded-lg">
          ...
          <div className="absolute w-full text-white left-5 bottom-5">
            ...
            <div className="flex items-center justify-start gap-x-3">
              <span className="p-3 border border-white rounded-lg">Action</span>
              <span className="p-3 border border-white rounded-lg">
                Adventure
              </span>
              <span className="p-3 border border-white rounded-lg">Drama</span>
            </div>
          </div>
        </div>
      </section>
